# TODO: The functions use global variables a little too much
        ...
        for epoch_idx in tglobal:
            ...
            with tqdm(dataloader, desc='Batch', leave=False) as tepoch:
                for nbatch in tepoch:
                    ...
                    image_features_1 = nets['vision_encoder_1'](nimage_1.flatten(end_dim=1))
                    image_features_1 = image_features_1.reshape(*nimage_1.shape[:2],-1)
                    image_features_2 = nets['vision_encoder_2'](nimage_2.flatten(end_dim=1))
                    image_features_2 = image_features_2.reshape(*nimage_2.shape[:2],-1)
                    # (B,obs_horizon,D)

                    # concatenate vision feature and low-dim obs
                    obs_features = torch.cat([image_features_1, image_features_2,  nagent_pos], dim=-1)
...
def main():
    ...
    torch.save(trained_nets.state_dict(), "savedWeights/toucht_trial.ckpt")
